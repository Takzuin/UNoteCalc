...
materias = {
    "PENSAMIENTO IUE": [(4.0, 15.0), (3.5, 20), (0, 15)],
    "TALLER DE LENGUAJE": [(1.8, 15.0),(5, 15.0), (3.5, 20.0)],
    "ÁLGEBRA Y TRIGONOMETRÍA": [(3.9, 9.0), (0.0, 9.0), (2.9, 20)],
    ...
    "INFRAESTRUCTURA TECNOLÓGICA": [(4.5, 2.0),(4.5, 20.0),(5.0, 5.0), (4.3, 2.0), (3.5, 12.0), (3.6, 5.0)]
}
